...
namespace VirtualPanel
{
    ...
    public class Lazy : Control
    {
        ...
        #region FactoryProperty

        /// <summary>
        ///     The DependencyProperty for Factory. 
        ///     Default value: Lazy
        /// </summary>
        public static readonly StyledProperty<Func<Control>?>
            FactoryProperty = AvaloniaProperty.Register<Lazy, Func<Control>?>(nameof(Factory));
